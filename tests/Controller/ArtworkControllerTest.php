...
class ArtworkControllerTest extends ControllerBaseCase {
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->entityManager->getRepository(Artwork::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/artwork/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(Artwork::class)->findAll());
