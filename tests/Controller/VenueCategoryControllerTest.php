...
class VenueCategoryControllerTest extends ControllerBaseCase {
    ...
    public function testAdminDelete() {
        $preCount = count($this->entityManager->getRepository(VenueCategory::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/venue_category/1/delete');
        $this->assertEquals(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(VenueCategory::class)->findAll());
