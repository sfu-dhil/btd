...
class ProjectPageControllerTest extends ControllerBaseCase {
    protected function fixtures() : array {
        return [
            UserFixtures::class,
            ProjectPageFixtures::class,
        ];
    }
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->entityManager->getRepository(ProjectPage::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/project/2/page/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(ProjectPage::class)->findAll());
