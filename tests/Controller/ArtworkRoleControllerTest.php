...
class ArtworkRoleControllerTest extends ControllerBaseCase {
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->entityManager->getRepository(ArtworkRole::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/artwork_role/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(ArtworkRole::class)->findAll());
