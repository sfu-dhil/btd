...
use AppBundle\DataFixtures\ORM\LoadProject;
...
class ProjectControllerTest extends BaseTestCase {
    ...
    public function testAdminEdit() {
        $client = $this->makeClient(LoadUser::ADMIN);
        $formCrawler = $client->request('GET', '/project/1/edit');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
        ...
        $client->submit($form);
        $this->assertTrue($client->getResponse()->isRedirect('/project/1'));
    ...
    public function testAdminNew() {
        $client = $this->makeClient(LoadUser::ADMIN);
        $formCrawler = $client->request('GET', '/project/new');
        $this->assertEquals(200, $client->getResponse()->getStatusCode());
    ...
    public function testAnonDelete() {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/project/1/delete');
        $this->assertEquals(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
    }
